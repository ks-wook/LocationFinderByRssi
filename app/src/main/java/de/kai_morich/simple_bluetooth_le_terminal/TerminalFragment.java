...
public class TerminalFragment extends Fragment implements ServiceConnection, SerialListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        receiveText.setTextColor(getResources().getColor(R.color.colorWhite)); // set as default color to reduce number of spans
    ...
    private void send(String str) {
        ...
        try {
            ...
            spn.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.colorWhite)), 0, spn.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
